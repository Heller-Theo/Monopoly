...
int main() {
    srand(time(NULL));
    CaseMonopoly plateauMonopoly[TAILLE_PLATEAU];
    InfoJoueur listeJoueur[NOMBRE_MAX_JOUEUR];
    CarteChanceCaisse infoChanceCaisse;

    int regleDepart = 0;
    int regleParcGratuit = 0;
    int potCommun = 0;
    int nombreJoueur = 2;
    int resultatDe = 0;
    int doubleDe = 0;
    ...
    affichageRegle(plateauMonopoly, &regleParcGratuit, &regleDepart);
